...
export const useAccountStore = defineStore('account', () => {
  ...
  async function fetchAccountById(id) {
    ...
    try {
      ...
      error.value = err.response?.data?.message || 'Đã xảy ra lỗi khi tải thông tin tài khoản'
      throw err
    } finally {
      loading.value = false
    }
  ...
  async function createAccount(accountData) {
    ...
    try {
      ...
      error.value = err.response?.data?.message || 'Đã xảy ra lỗi khi tạo tài khoản mới'
      throw err
    } finally {
      loading.value = false
    }
  ...
  async function updateAccount(id, accountData) {
    ...
    try {
      ...
      error.value = err.response?.data?.message || 'Đã xảy ra lỗi khi cập nhật tài khoản'
      throw err
    } finally {
      loading.value = false
    }
  ...
  async function deleteAccount(id) {
    ...
    try {
      ...
      error.value = err.response?.data?.message || 'Đã xảy ra lỗi khi xóa tài khoản'
      throw err
    } finally {
      loading.value = false
    }
  ...
  async function toggleAccountActive(id, isActive) {
    ...
    try {
      ...
      error.value = err.response?.data?.message || 'Đã xảy ra lỗi khi thay đổi trạng thái kích hoạt tài khoản'
      throw err
    } finally {
      loading.value = false
    }
