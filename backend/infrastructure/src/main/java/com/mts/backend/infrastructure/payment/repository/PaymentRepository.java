package com.mts.backend.infrastructure.payment.repository;
...
import com.mts.backend.infrastructure.payment.jpa.JpaPaymentRepository;
...
import com.mts.backend.infrastructure.persistence.entity.PaymentMethodEntity;
...
public class PaymentRepository implements IPaymentRepository {
    ...
    protected Payment create(Payment payment) {
        ...
        PaymentEntity en = PaymentEntity.builder()
                ...
                .amountPaid(payment.getAmountPaid().map(Money::getAmount).orElse(null))
                .changeAmount(payment.getChangeAmount().map(Money::getAmount).orElse(null))
