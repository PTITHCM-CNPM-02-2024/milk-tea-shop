create table milk_tea_shop_prod.order_discount
(
...
grant insert, update on table milk_tea_shop_prod.order_discount to thanhphuong_staff;

grant insert, update on table milk_tea_shop_prod.order_discount to vanphong_staff;

grant insert, update on table milk_tea_shop_prod.order_discount to thanhphuong_staff@localhost;

grant insert, update on table milk_tea_shop_prod.order_discount to vanphong_staff@localhost;
