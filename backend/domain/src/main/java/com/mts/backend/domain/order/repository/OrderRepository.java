...
import com.mts.backend.domain.persistence.entity.*;
...
import com.mts.backend.domain.order.jpa.JpaOrderDiscountRepository;
import com.mts.backend.domain.order.jpa.JpaOrderProductRepository;
import com.mts.backend.domain.order.jpa.JpaOrderRepository;
import com.mts.backend.domain.order.jpa.JpaOrderTableRepository;
    ...
    protected void createDiscounts(OrderId id, Set<OrderDiscount> discounts) {
        ...
        discounts.forEach(discount -> {
            OrderDiscountEntity ordDisEn = OrderDiscountEntity.builder()
                    ...
                    .discountAmount(discount.getDiscountAmount().getValue())
                    .build();
