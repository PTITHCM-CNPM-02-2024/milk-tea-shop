...
(
    ...
    min_prod_nums        tinyint unsigned  not null comment 'Số lượng sản phẩm tối thiểu từ danh mục này để áp dụng giảm giá',
...
(
    ...
    min_required_prod   smallint unsigned not null comment 'Số lượng tối thiểu của sản phẩm để áp dụng giảm giá',
