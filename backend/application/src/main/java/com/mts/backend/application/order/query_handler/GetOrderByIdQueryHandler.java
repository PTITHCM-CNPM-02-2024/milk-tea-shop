        ...
        var result = OrderDetailResponse.builder()
                ...
                .orderProducts(order.getOrderProducts().stream()
                        .map(orderProduct -> OrderProductDetailResponse.builder()
                                .productName(orderProduct.getProductPriceEntity().getProductEntity().getName().getValue())
                                .quantity(orderProduct.getQuantity())
                                .price(orderProduct.getProductPriceEntity().getPrice().getValue())
                                .quantity(orderProduct.getQuantity())
                                .build())
                        .toList())
                ...
                .orderPayments(order.getPayments().stream().map(orderPayment -> PaymentDetailResponse.builder()
                        .paymentMethod(PaymentMethodDetailResponse.builder()
                                ...
                                .name(orderPayment.getPaymentMethod().getPaymentName().getValue())
                                .description(orderPayment.getPaymentMethod().getPaymentDescription().orElse(null))
                                .build())
