...
-- Trigger kiểm tra thời hạn khi cập nhật MembershipType
...
-- Trigger kiểm tra thời hạn khi thêm mới MembershipType
...
BEGIN
    ...
    UPDATE Customer c
        JOIN MembershipType mt ON c.membership_type_id = mt.membership_type_id
