...
(
    ...
    constraint InventoryTransaction_ibfk_1
        foreign key (material_id) references milk_tea_shop_dev.Material (material_id),
    constraint InventoryTransaction_ibfk_2
        foreign key (supplier_id) references milk_tea_shop_dev.Supplier (supplier_id),
    constraint InventoryTransaction_ibfk_3
        foreign key (manager_id) references milk_tea_shop_dev.Manager (manager_id)
);
